            ...
            GM_xmlhttpRequest({
                ...
                onload: function(response) {
                    ...
                    if (item.code == "200") {
                        ...
                        $($("td.c7")[index]).html( "<a href='http://www.vvic.com/item/"+ item.data.id +"'><img src='http://"+item.data.index_img_url + "_80x80.jpg' /></a>");
                        ...
                        $($("td.c2")[index]).html(item.data.art_no);

                        console.log("totalNum:" + totalNum+" totalPrice:" + totalPrice);
                        $("table.total-order-info").html("<th>商品总价: "+  totalPrice + "</th><th>总件量: " + totalNum + " </th><th>运费：6</th><th style='color:red;font:bold'>订单总价:" + (totalPrice +6+ (totalNum *2)) + "</th>");
                        ...
                        GM_xmlhttpRequest({
                            ...
                            onload: function (response) {
                                ...
                                if (shop.code == "200") {
                                    text = "<br>" + shop.data.marketName + "-" + shop.data.floor + "-" + shop.data.position;
