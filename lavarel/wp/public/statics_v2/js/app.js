    ...
    controllers: {
        ...
        objectsDetailController: {
            ...
            initLiveChart: function () {
                ...
                if ($('table.objectsDetail').attr('data-period') == 180) {
            ...
            clickedOrderUp: function () {
                ...
                html = html.replace(/#RETURNRATE#/, $('#returnrate').val());
                        ...
                        if (parseInt($(this).attr('data-seconds')) - 1 < 0) {
                            ...
                            if (parseInt($(this).attr('data-direction')) == 1) {
                                if ($item.body_price > parseFloat($(this).attr('data-price-buying'))) {
									...
									var  currentnum = $(this).find('#currentnumber').html();
									$(this).find('#yingkui').css("color","green");
									if($item.body_price == parseFloat($(this).attr('data-price-buying'))){
										$(this).find('#yingkui').html(0);

									}else{
										$(this).find('#yingkui').html("-"+currentnum);
									}
							...
							var curtem = $(this).next().find('#daojishi').html()-1;
							$(this).next().find('#daojishi').html(curtem);
                        }
                    });
                }
            }
