...
class AdministratorController extends Controller {
    ...
    public function home(Request $request) {
        ...
        //所有用户都一个默认的id_agent 默认都是0 ，表示平台是最大的机构
        //判断身份类型，如果type =0 表示是平台管理员，如果type = 1 表示是机构 ，则查询机构所属的用户
        if($type == 4){
            //会员
