                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a href="/administrator/users?id_introducer=<?php echo $item->id; ?>">名下客户</a>|<?php if ($type == 0) { ?>| <a href="/administrator/payRequests/<?php echo $item->id; ?>">人工充值</a> | <a href="/administrator/users/<?php echo $item->id; ?>/withhold">人工扣款</a> <?php } ?> 
                                    <!--
                                        <a href="/administrator/orders?id_user=<?php echo $item->id; ?>">订单记录</a> | <a href="/administrator/records?id_user=<?php echo $item->id; ?>">资金记录</a> | <a href="/administrator/payRequests?id_user=<?php echo $item->id; ?>">充值记录</a> | <a href="/administrator/withdrawRequests?id_user=<?php echo $item->id; ?>">提现记录</a>  <?php if ($type == 0) { ?>| <a href="/administrator/payRequests/<?php echo $item->id; ?>">人工充值</a> | <a href="/administrator/users/<?php echo $item->id; ?>/withhold">人工扣款</a> <?php } ?> |  | <a href="/administrator/users/<?php echo $item->id; ?>/status">封禁切换</a>
                                        -->
                                    </td>
                                </tr>
                                <?php } ?>
