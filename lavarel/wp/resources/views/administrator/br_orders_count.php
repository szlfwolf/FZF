        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row" style="margin-top: 20px;">
                    <form method="get" action="/administrator/br_orders_count">
                                <div class="input-group custom-search-form">
                                     <div class="form-group">
                                        <label class="control-label col-md-1"  style="margin-top:10px">经纪人</label>
                                        <div class="col-md-3">
                                            <select id="id_broker" name="id_broker" type="text" class="form-control select2" placeholder="经纪人...">
                                                 <?php foreach ($members as $item) { ?>
                                                <option value="<?php echo $item->id; ?>"><?php echo $item->body_phone; ?></option>
                    ...
                    <form id="ExportForm"  method="post" style="display: none;" action="/administrator/br_orders_count_ex">
