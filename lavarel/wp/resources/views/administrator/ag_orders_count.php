        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row" style="margin-top: 20px;">
                    <form method="get" action="/administrator/ag_orders_count">
                                <div class="input-group custom-search-form">
                                     <div class="form-group">
                                        <label class="control-label col-md-1" style="margin-top:10px">机构</label>
                                        <div class="col-md-3">
                                            <select id="id_agent" name="id_agent" type="text" class="form-control select2" placeholder="机构...">
                     ...
                     <form id="ExportForm"  method="post" style="display: none;" action="/administrator/ag_orders_count_ex">
