                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="/agent/orders?id_user=<?php echo $item->id_user; ?>"><?php echo $item->id_user; ?></a> (<a href="/agent/users?id_user=<?php echo $item->id_user; ?>"><?php echo $item->user->body_phone; ?></a>)</td>
                                    <td><?php echo $item->user->is_disabled == 0 ? '<span style="color: green;">正常</span>' : '<span style="color: red;">封停</span>'; ?></td>
                                    <td><a href="/agent/orders?id_object=<?php echo $item->id_object; ?>"><?php echo $item->object->body_name; ?></a></td>
