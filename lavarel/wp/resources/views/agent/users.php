                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $item->id_introducer == 0 ? '自发注册' : '<a href="/agent/users?id_user=' . $item->id_introducer . '">' . $item->id_introducer . '</a>'; ?></td>
                                    ...
                                    <td>
                                        <a href="/agent/orders?id_user=<?php echo $item->id; ?>">订单记录</a> | <a href="/agent/records?id_user=<?php echo $item->id; ?>">资金记录</a> | <a href="/agent/payRequests?id_user=<?php echo $item->id; ?>">充值记录</a> | <a href="/agent/withdrawRequests?id_user=<?php echo $item->id; ?>">提现记录</a> | <a href="/agent/users?id_introducer=<?php echo $item->id; ?>">名下用户</a> |
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
