    <div class="navigator clearfix">
        <a class="<?php echo ($navigator=='objects')? 'active' : '';?>" href="/objects" class="active">商品价格</a>
        <a class="<?php echo ($navigator=='ordersHold')? 'active' : '';?>" href="/orders/hold">在手订单</a>
        <a class="<?php echo ($navigator=='ordersHistory')? 'active' : '';?>" href="/orders/history">历史订单</a>
        <a class="<?php echo ($navigator=='account')? 'active' : '';?>" href="/account">我的账户</a>
    </div>
